  ...
  if (!session || !session.user) {
    return (
      <Button
        ...
        className="gap-2 text-xs border-white/10 hover:border-white/20 bg-white/5 hover:bg-white/10 text-slate-200"
      >
        {/* Google G Icon */}
  ...
  return (
    <div className="relative" ref={menuRef}>
      <button
        ...
        className="flex items-center gap-2 p-1 pr-2 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 transition-colors cursor-pointer"
      >
        {user.image ? (
          <img
            src={user.image}
          ...
          <div className="w-7 h-7 rounded-full bg-purple-600/30 text-purple-300 font-bold text-xs flex items-center justify-center border border-purple-500/30">
            {initials}
          </div>
        )}
